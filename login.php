...
<body>
    <header class="header">
        <img class="header_img" src="./views/img/cefte.png" alt="logo-cefte">
    </header>
    <!--<section class="login">
        <section class="login_container">
            <h2>Inicia Sesión</h2>
            <form class="login_container_form">
                <input type="text" class="input" placeholder="Correo">
                <input type="password" class="input" placeholder="Contraseña">
                <button class="button">Iniciar Sesion</button>
                <div class="login_container_remember_me">
                    <label>
                        <input type="checkbox" id="cbox1" name="" value="checkbox">Recuérdame
                    </label>
                    <a href="#">Olvidé mi contraseña</a>
                </div>
            </form><br>
            <p class="login_container_register">No tienes ninguna cuenta <a href="">Registrate</a></p>
        </section>
    </section>-->
        ...
        <form >
                ...
                <div>
                    <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                        ...
                        <g class="body">
                            ...
                            <path fill="#b3dcf0" d="M100,156.4c-22.9,0-43,11.1-54.1,27.7c15.6,10,34.2,15.9,54.1,15.9s38.5-5.8,54.1-15.9 C143,167.5,122.9,156.4,100,156.4z"/>
                        </g>
                        <g class="earL">
                            <g class="outerEar" fill="#b3dcf0" stroke="#3a5e77" stroke-width="2.5">
                        ...
                        <g class="earR">
                            <g class="outerEar">
                                <circle fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" cx="153" cy="83" r="11.5"/>
                                <path fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M153.7,78.9 c2.3,0,4.1,1.9,4.1,4.1c0,2.3-1.9,4.1-4.1,4.1"/>
                            </g>
                            <g class="earHair">
                        ...
                        <path class="face" fill="#b3dcf0" d="M134.5,46v35.5c0,21.815-15.446,39.5-34.5,39.5s-34.5-17.685-34.5-39.5V46"/>
                        ...
                        <g class="arms" clip-path="url(#armMask)">
                            <g class="armL" style="visibility: hidden;">
                                <polygon fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="121.3,98.4 111,59.7 149.8,49.3 169.8,85.4"/>
                                <path fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M134.4,53.5l19.3-5.2c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-10.3,2.8"/>
                                <path fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M150.9,59.4l26-7c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-21.3,5.7"/>
                                
                                <g class="twoFingers">			
                                    <path fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M158.3,67.8l23.1-6.2c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-23.1,6.2"/>
                                    <path fill="#A9DDF3" d="M180.1,65l2.2-0.6c1.1-0.3,2.2,0.3,2.4,1.4v0c0.3,1.1-0.3,2.2-1.4,2.4l-2.2,0.6L180.1,65z"/>
                                    <path fill="#b3dcf0" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M160.8,77.5l19.4-5.2c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-18.3,4.9"/>
                            ...
                            <g class="armR" style="visibility: hidden;">
                                <path fill="#b3dcf0" stroke="#3a5e77" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2.5" d="M265.4 97.3l10.4-38.6-38.9-10.5-20 36.1z"/>
                                <path fill="#b3dcf0" stroke="#3a5e77" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2.5" d="M252.4 52.4L233 47.2c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l10.3 2.8M226 76.4l-19.4-5.2c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l18.3 4.9M228.4 66.7l-23.1-6.2c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l23.1 6.2M235.8 58.3l-26-7c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l21.3 5.7"/>
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="email" id="loginEmail" placeholder="usuario@gmail.com" maxlength="254" />
            </div>
